      ...
      _createClass(GreenAudioPlayer, [{
        ...
        value: function initEvents() {
          ...
          this.player.addEventListener('loadedmetadata', function () {
            self.totalTime.textContent = this.getAttribute('data-name');
          });
