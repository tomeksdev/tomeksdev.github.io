...
author: vujca
date: 2023-09-27 11:33:00 +0100
categories: [Blogging]
tags: [linux, servers, script, tomeks, vujca, blog, post, technology, hardware, learning, virtualization]
image:
  path: /assets/img/post/TomeksDEV-blog-small.png
  alt: TomeksDEV
---
...
*![Alt]({{ '/assets/img/post/NewBlog/network.jpg' | relative_url }} "Networking")*
...
*![Alt]({{ '/assets/img/post/NewBlog/systems.jpg' | relative_url }} "Systems")*
